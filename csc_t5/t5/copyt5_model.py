...
from t5.config.model_args import CopyT5Args
from t5.copyt5_utils import CopyT5Dataset, load_hf_dataset, copy_loss, ZHTokenizer
...
MODEL_CLASSES = {
    "t5": (T5Config, CopyT5ForConditionalGeneration, ZHTokenizer),
}
